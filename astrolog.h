/*
** Astrolog (Version 5.41) File: astrolog.h
**
...
#define DEFAULT_LONG -8.32 /* Change these values to the longitude west    */
#define DEFAULT_LAT  47.23 /* and latitude north of your current location. */
